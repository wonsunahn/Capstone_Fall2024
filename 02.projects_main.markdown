...
# Schedule
[Check the schedule here]({{site.baseurl}}/projects_presentation_schedule).
...
### Project Presentation
  ...
  * Listeners will have to evaluate the presentation -->
  ...
  See the [Presentation Schedule]({{site.baseurl}}/presentation_schedule) for when you will be presenting.
